...
public class Utility {
	...
	public static void captureScreenShot(WebDriver driver, String fileName) throws IOException {
		...
		File dest= new File("C:\\Users\\Atul\\eclipse-workspace1\\AmazonProject\\Screenshots\\"+fileName+".png");
	...
	public static String excelread(int row, int col) throws EncryptedDocumentException, IOException {
		...
		FileInputStream fis=new FileInputStream("C:\\Users\\Atul\\eclipse-workspace1\\AmazonProject\\Excelsheets\\Amazon_Excel.xlsx");
